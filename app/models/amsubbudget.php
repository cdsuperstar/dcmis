...
class amsubbudget extends Model
{
    ...
    protected $fillable = ['amapplication_id','name','req','addr','picharge','picphone','wzno','wzsmodel','amt','reqamt','bdg','price','purchway','purchstate','purchdate','reimstate','contrno','amsupplier_id','asstate','regamt','scrapamt','total','remark'];
