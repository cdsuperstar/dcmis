...
//        usermsg::where('recver_id',$theUserid)->update(['readtime'=>Carbon::now()]);
    ...
    public function sendMsg(Request $request)
    {
        ...
        if ($rec->save()) {
            ...
            event(new \App\Events\usercmd($resData->first()->recver_id,"if(angular.element(\"#msgcontent\")!=undefined){angular.element(\"#msgcontent\").scope().chartMsgs.unshift(".$resData->first()->toJson().");}"));
