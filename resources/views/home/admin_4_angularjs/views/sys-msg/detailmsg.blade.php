<!-- BEGIN MAIN CONTENT -->
<div class="portlet-body" data-ng-controller="sysmsgCtrl" style="width: 500px;">
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto;">
        <div class="comment">
            <div class="com_form form-body">
                <div class="form-group">
                    <label class="col-md-3 control-label" style="margin-top: 6px;"> 人员列表 </label>
                    <div class="col-md-9">
                ...
                <div class="form-group">
                    <label class="col-md-3 control-label" style="margin-top: 6px;"> 消息内容 </label>
                    <div class="col-md-9">
                ...
                <div id="speecscroll" class="spscroller" style="height: 400px; overflow: auto; width: auto;margin-top: 15px;">
