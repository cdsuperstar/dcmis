<!-- BEGIN MAIN CONTENT -->
<div class="row" data-ng-controller="userdepartmentCtrl">
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption font-dark">
                <i class="icon-social-dropbox font-dark"></i>
                <span class="caption-subject bold uppercase"> 机构设置 </span>
            </div>
        </div>
        <div class="portlet-body">
            ...
            <div id="userdepartmentgrid" ui-grid="gridOptions" ui-grid-selection  ui-grid-edit ui-grid-row-edit ui-grid-pagination ui-grid-cellNav ui-grid-resize-columns ui-grid-move-columns class="userdepartGrid"></div>
        </div>
    </div>
</div>