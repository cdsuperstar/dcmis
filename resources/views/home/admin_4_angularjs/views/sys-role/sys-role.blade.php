<!-- BEGIN MAIN CONTENT -->
<div class="portlet-body" data-ng-controller="rolesCtrl">
    ...
    <div id="rolegrid" ui-grid="gridOptions" ui-grid-selection  ui-grid-edit ui-grid-row-edit ui-grid-pagination ui-grid-cellNav ui-grid-resize-columns ui-grid-move-columns class="userGrid"></div>
</div>
