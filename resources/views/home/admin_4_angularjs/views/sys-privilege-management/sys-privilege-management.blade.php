...
<div class="portlet-body" data-ng-controller="privilegemanagementCtrl">
    <div class="table-toolbar">
        ...
        <button id="delData" type="button" class="btn btn-danger" confirmation-needed="确定要删除这些权限数据吗？" ng-click="delData()"><i class="fa fa-trash"></i> 删除</button>
    ...
    <div id="privilegrid" ui-grid="gridOptions" ui-grid-selection  ui-grid-edit ui-grid-row-edit ui-grid-pagination ui-grid-cellNav ui-grid-resize-columns ui-grid-move-columns class="sysPrivilegeGrid"></div>
</div>
