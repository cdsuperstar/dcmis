...
<div class="row" data-ng-controller="dcuserCtrl">
    ...
    <button id='toggleFiltering' ng-click="toggleFiltering()" class="btn btn-success">筛选</button>
    <button id="refreshButton" type="button" class="btn btn-success" ng-click="refreshData()">重获数据</button>
