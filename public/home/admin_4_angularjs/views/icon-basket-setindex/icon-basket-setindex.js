    ...
    ['$scope', 'Restangular', '$q', '$filter', 'ngDialog','uiGridConstants','i18nService',
        function ($scope, Restangular, $q, $filter, ngDialog,uiGridConstants,i18nService) {
            ...
            $scope.gridOptions = {
                ...
                columnDefs: [
                    {name: '编号', field: 'id', enableCellEdit: false, width: '100',enableFiltering: true,enableColumnResizing:false},
                    ...
                    {name: '单位',width: '50',field: 'munit', enableCellEdit: true,cellFilter: 'date:"yyyy-M-d"',type: 'date'},
                    {name: '物资简拼', width: '150',field: 'mspell',enableCellEdit: false,visible:true},
