                        ...
                        switch($scope.templatesign)
                        {
                            case "1":
                            {
                                ...
                                $scope.soucegridOptions.columnDefs=[
                                    ...
                                    {name: '申报数量', field: 'reqamt',width: '80',enableCellEdit: false,enableColumnMenu: true,aggregationType: uiGridConstants.aggregationTypes.sum,aggregationHideLabel: true},
                                    ...
                                    {name: '采购数量', field: 'amt',width: '80',enableCellEdit: true,enableColumnMenu: true,aggregationType: uiGridConstants.aggregationTypes.sum,aggregationHideLabel: true},
